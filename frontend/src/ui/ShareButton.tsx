...
function ShareButton({ id }: { id: Number }) {
    const Link = `https://blogit-blogs.vercel.app/blog/${id}`
    ...
    return (
        <div>
            <Toaster />
            <button onClick={shareMe} title="Share"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
