    ...
    return <div>
        ...
        {isLoading ? <CardSkeleton type={"blogs"} /> : <div>
            ...
            <div className="mb-5 flex justify-center    ">
                ...
                <div className="w-auto  flex flex-col-reverse ">

                    <div>


                        <div className="  p-2 bg-white border-b-4   w-full ">
                            <div className="flex items-center justify-center -z-10 ">

                                <h1 className=" text-xl font-clash_display font-semibold text-center">All Blogs Of Author</h1>
                            </div>
                        </div>
                        ...
                        {data?.map((blog) => (
                            <div className="" key={blog.id}>
                                ...
                                <div className="font-clash_display  px-5 py-0  border-b-2  border-gray-200 h-36  max-h-36 sm:max-h-36 sm:min-h-36 oerflow-hidden" >
                    ...
                    <div className=" ">
                        <div className="  -z-10   p-5   md:w-80 border-x-2 gap-5 flex justify-center ">
